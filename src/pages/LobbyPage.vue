<template>
  <q-page class="q-pa-md column flex-center bg-blue-grey-5">
    <q-card class="q-pa-md row flex-center bg-green-1" style="width: 80%; min-height: 500px; flex: 1">
      <div class="q-pa-md column flex-center bg-blue-grey-3" style="width: 80%; margin: 5px">
        <LobbyDiv
          :items="[
      ...
      <div class="q-pa-sm column flex-center" style="flex: auto">
        ...
        <q-btn flat class="q-pa-sm flex-center bg-white" style="font-size: large; font-weight: bold">Join</q-btn>
      </div>
    </q-card>
  </q-page>
</template>
