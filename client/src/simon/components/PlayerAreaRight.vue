<template>
  ...
  >
    ...
    <div class="column reverse flex-center">
      <comp-tile
        v-for="(tile, index) in rightCardsVisible"
        :key="index"
        :type="tile"
        :back="!shouldRevealRight && isReal(tile.id)"
        size="large"
        position="right"
...
// PlayerAreaRight.vue
const targetSeat = computed(() => (mySeat.value != null ? mapPosition(mySeat.value, Direction.Right) : null));
