 ...
 */
class CardType {
  constructor(public type: string, public value: number, public name: string) {
    this.type = type;
    this.value = value;
    this.name = name;
  }
 ...
 */
class CardGame {
  constructor(public cards: Card[] = [], public walls: CardWall[] = []) {
    this.walls = [
      new CardWall('East'),
      new CardWall('South'),
      new CardWall('West'),
...
class CardWall {
  constructor(public direction: string, public cards: Card[] = []) {
